...
public class Assurance_p {
	private String policy_state;
	private String policy_csl;
	...
	private String incident_period_of_day;
	private String collision_type;
	private String property_damage;
	private String police_report_available;
	public Assurance_p(String policy_state, String policy_csl, String insured_sex, String insured_education_level,
			String insured_occupation, String insured_hobbies, String insured_relationship, String incident_type,
			String incident_severity, String authorities_contacted, String incident_state, String incident_city,
			String auto_make, String auto_model, String incident_period_of_day, String collision_type,
			String property_damage, String police_report_available) {
		super();
		...
		this.incident_period_of_day = incident_period_of_day;
	...
	public void setPolicy_csl(String policy_csl) {
		this.policy_csl = policy_csl;
	}
	...
	public void setIncident_city(String incident_city) {
		this.incident_city = incident_city;
	}
	...
	public String getIncident_period_of_day() {
		return incident_period_of_day;
	}
	public void setIncident_period_of_day(String incident_period_of_day) {
		this.incident_period_of_day = incident_period_of_day;
	}
